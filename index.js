window.onload = function() {
  alert("Please Rotate the Screen Momo....?");
};
    ...
    // 1031 === oldMan
      ...
      characters.push(
        new Character({
          ...
          scale: 1,
          dialogue: ['Momo: Why are you just standing here?.',"Afridi: Because I havent fully made the game!","Momo: Whyyyy?","Afridi: The game development was stopped.","Afridi: on 7th february", "Afridi: Yk what I mean right?","Momo: .......","Momo: Huh...." ]
        })
      );
    }
    // 1028 === flower (positioned below the villager)
    else if (symbol === 1026) {
      characters.push(
        new Character({
          position: {
            x: j * Boundary.width + offset.x,
            y: i * Boundary.height + offset.y + 200 // Move the flower 16px down
          },
          image: flowerImg,
          frames: {
            max: 1, // No animation for the flower
            hold: 60
          },
          scale: 1, // Adjust scale if needed
          dialogue: ['A beautiful flower!']
        })
      );
    }
